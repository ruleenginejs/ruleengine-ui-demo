import{r as c,c as E,o as h,a as he,b as fe,d as f,e as n,f as A,g as e,w as o,t as ge,h as T,i as ke,F as k,j as b,k as x,l as j,m as M,n as L,p as ye,q as xe,s as $e,u as Ce}from"./vendor.f306c535.js";const we=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const _ of document.querySelectorAll('link[rel="modulepreload"]'))l(_);new MutationObserver(_=>{for(const p of _)if(p.type==="childList")for(const t of p.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&l(t)}).observe(document,{childList:!0,subtree:!0});function r(_){const p={};return _.integrity&&(p.integrity=_.integrity),_.referrerpolicy&&(p.referrerPolicy=_.referrerpolicy),_.crossorigin==="use-credentials"?p.credentials="include":_.crossorigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function l(_){if(_.ep)return;_.ep=!0;const p=r(_);fetch(_.href,p)}};we();var g=(u,i)=>{const r=u.__vccOpts||u;for(const[l,_]of i)r[l]=_;return r};const Se={name:"App"};function je(u,i,r,l,_,p){const t=c("router-view");return h(),E(t)}var Oe=g(Se,[["render",je]]);const Te="modulepreload",D={},Ie="/ruleengine-ui-demo/",w=function(i,r){return!r||r.length===0?i():Promise.all(r.map(l=>{if(l=`${Ie}${l}`,l in D)return;D[l]=!0;const _=l.endsWith(".css"),p=_?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const t=document.createElement("link");if(t.rel=_?"stylesheet":Te,_||(t.as="script",t.crossOrigin=""),t.href=l,document.head.appendChild(t),_)return new Promise((a,s)=>{t.addEventListener("load",a),t.addEventListener("error",s)})})).then(()=>i())},Ve=()=>w(()=>import("./demo-component-layout.3fa5bd04.js"),["assets/demo-component-layout.3fa5bd04.js","assets/vendor.f306c535.js"]),ze=()=>w(()=>import("./demo-component-page.655fb260.js"),["assets/demo-component-page.655fb260.js","assets/vendor.f306c535.js"]);var Ee=[{path:"component",redirect:"/component/installation",name:"component",component:Ve,children:[{path:":id",name:"component-content",props:!0,component:ze}]}];const Ae=()=>w(()=>import("./demo-layout.217aa32b.js"),["assets/demo-layout.217aa32b.js","assets/demo-header.56fd6d4c.js","assets/vendor.f306c535.js"]),Me=()=>w(()=>import("./demo-home.d39dab8a.js"),["assets/demo-home.d39dab8a.js","assets/vendor.f306c535.js"]);var Le=[{path:"/",component:Ae,children:[{path:"",name:"home",component:Me},...Ee]}];const De=()=>w(()=>import("./demo-not-found.964c2554.js"),["assets/demo-not-found.964c2554.js","assets/demo-header.56fd6d4c.js","assets/vendor.f306c535.js"]);var Be=[{path:"/:pathMatch(.*)",name:"not-found",component:De}];const Ue=he({history:fe(),routes:[...Le,...Be]}),Fe={name:"demo-block"},qe={class:"demo-block"},Pe={class:"demo-block__source"},Re={class:"demo-block__code"};function Ne(u,i,r,l,_,p){const t=c("v-sidebar-section");return h(),f("div",qe,[n("div",Pe,[A(u.$slots,"default")]),n("div",Re,[e(t,{"bottom-border":!1,"header-border":!1,title:"Code"},{default:o(()=>[A(u.$slots,"code")]),_:3})])])}var We=g(Fe,[["render",Ne]]),He=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:We});const Ke=`
<template>
  <v-action-bar>
